    ...
    <div className="relative hidden md:block">
      ...
      <div className="relative">
        ...
        <input
          ...
          autoComplete="off"
          className="h-9 w-56 rounded-lg border border-zinc-200 bg-zinc-50 py-1.5 pr-8 pl-9 text-xs text-zinc-900 transition-all placeholder:text-zinc-400 focus-visible:border-blue-500 focus-visible:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/20 lg:w-72"
        />
        {inputValue && (
          <button
            type="button"
          ...
          {suggestions.length > 0 && (
            <ul className="max-h-64 overflow-y-auto py-1">
              ...
              <li className="flex items-center justify-between border-zinc-100 border-t px-3.5 py-2">
                ...
                <span className="text-[10px] text-zinc-400">
                  <kbd className="rounded border border-zinc-200 bg-zinc-100 px-1 py-0.5 font-mono text-[9px]">
                    ↵
                  </kbd>{" "}
                  search all ·{" "}
                  <kbd className="rounded border border-zinc-200 bg-zinc-100 px-1 py-0.5 font-mono text-[9px]">
