			...
			{inputValue && (
				<button
					...
					onClick={() => {
						...
						params.delete("search");
						params.delete("client");
						router.replace(params.toString() ? `/campaigns?${params.toString()}` : "/campaigns", {
							scroll: false,
						});
					}}
...
export default function CampaignManager({
	...
	const selectedClient = selectedClientPromise ? use(selectedClientPromise) : null;
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
				...
				<div className="lg:col-span-2 flex flex-col gap-4">
					<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
						...
						<CampaignSearchBar
							initialSearch={selectedClient ? selectedClient.name : currentSearch}
