...
export function TableHeader({
  ...
  return <thead className={cn("border-b border-zinc-800 bg-zinc-900/50", className)} {...props} />;
}
...
export function TableCell({
  ...
  return (
    <td
      className={cn("p-4 align-middle [&:has([role=checkbox])]:pr-0 text-zinc-100", className)}
      {...props}
    />
  );
}
